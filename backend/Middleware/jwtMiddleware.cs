...
namespace backend.Middleware
{
    public class jwtMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, IUserService userService, IRoleProcessService roleProcessService)
        {
        ...
        private async Task attachUserToContext(HttpContext context, IUserService userService, IRoleProcessService roleProcessService, string token)
        {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    //驗證角色權限
                                    if (!RolePermissionsChecked(PayLoad["role"].ToString(), Path, URLMethod, roleProcessService))
                                        await BadResponse(Response);
                                }
                            }
                        }
        ...
        public Boolean RolePermissionsChecked(string Role, string Path, string URLMethod, IRoleProcessService roleProcessService)
        {
